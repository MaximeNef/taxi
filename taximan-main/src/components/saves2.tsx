    ...
    return (
        <div className="my-[150px] px-5 ">
            <div data-aos="fade-down" data-aos-duration="1000"> 
                <H3 className="m-auto max-w-[200px]  mb-[-8px]"text={t("thirdSection.h3")} />
                <H2 color={isGrey} text={t("thirdSection.h2")} />

            </div>
            <div className="justify-center sm:mt-[40px] xsm:mt-[80px] xsm:flex flex-row xsm:items-center m-auto  xsm:px-[20px] lg:px-[50px] xl:px-[100px] 2xl:px-[200px]">
                <Image
                    data-aos="fade-up" data-aos-duration="1000"
                    className="sm:pt-[0px] sm:mb-[60px] xsm:pt-[0px] xl:w-auto xl:max-w-[600px] h-auto "
                    src="/assets/pictures/car.png"
                ...
                />
                <div data-aos="fade-up" data-aos-duration="1000" className="xsm:w-[50%] xl:min-w-[400px] xl:w-auto md:ml-[150px]">
                    {SecondSubsectionsData.map((subsection, index) => (
                        <div key={index} className={` ${ index % 3 === 1 ? 'flex flex-row-reverse ' : ''}`} >
                            <SecondSubsection
            ...
            <div data-aos="fade-up" data-aos-duration="1000" className="mt-[50px] w-full flex flex-col">

                <Button className="w-auto m-auto" mr={true} fontSize={true} fontWeight={false} color={false} background={true} showLogo={true} hoverEffect={true} />
            </div>
        </div>
    )
}
